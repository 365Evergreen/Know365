...
export const HomeIcon: React.FC<IconProps> = ({ size = 16, style, ...rest }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} fill="currentColor" style={style} {...rest}>
    <path d="M12 3l9 8h-3v9h-12v-9h-3l9-8z" />
  </svg>
);

export const DocumentationIcon: React.FC<IconProps> = ({ size = 16, style, ...rest }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} fill="currentColor" style={style} {...rest}>
    <path d="M6 2h9l5 5v13a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1zM14 3v5h5" />
  </svg>
);

export const SearchIcon: React.FC<IconProps> = ({ size = 16, style, ...rest }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} fill="currentColor" style={style} {...rest}>
...
export const SettingsIcon: React.FC<IconProps> = ({ size = 16, style, ...rest }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} fill="currentColor" style={style} {...rest}>
...
export const DatabaseIcon: React.FC<IconProps> = ({ size = 16, style, ...rest }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} fill="currentColor" style={style} {...rest}>
...
export const SunIcon: React.FC<IconProps> = ({ size = 16, style, ...rest }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} fill="currentColor" style={style} {...rest}>
    <path d="M6.76 4.84l-1.8-1.79L3.17 4.84l1.79 1.8 1.8-1.8zM1 13h3v-2H1v2zm10 8h2v-3h-2v3zm7.03-2.03l1.79 1.79 1.79-1.79-1.79-1.79-1.79 1.79zM17.24 4.84l1.79-1.79-1.79-1.79-1.79 1.79 1.79 1.79zM20 11v2h3v-2h-3zM12 6a6 6 0 100 12 6 6 0 000-12z" />
  </svg>
);

export const MoonIcon: React.FC<IconProps> = ({ size = 16, style, ...rest }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} fill="currentColor" style={style} {...rest}>
    <path d="M12.74 2.36a9 9 0 1010.9 10.9 7 7 0 01-10.9-10.9z" />
  </svg>
);
